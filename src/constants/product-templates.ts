  ...
  sections: [
    {
      ...
      fields: [
        ...
        { key: 'subtitle', type: 'string', label: 'Mô tả ngắn', required: false },
        { key: 'image', type: 'image', label: 'Ảnh nền', required: false },
      ],
    },
    {
      id: 'features',
      ...
      required: false,
      fields: [
        { key: 'items', type: 'array', itemType: 'string', label: 'Danh sách tiện ích', required: false },
      ],
    },
    {
      id: 'description',
...
export const investorFocusedTemplate: ProductPageTemplate = {
  ...
  sections: [
    ...
    },
    {
      ...
      required: false,
      fields: [
        { key: 'price', type: 'string', label: 'Giá chào bán', required: false },
        { key: 'pricePerSqm', type: 'string', label: 'Đơn giá / m²', required: false },
        { key: 'projectedRoi', type: 'string', label: 'ROI dự kiến', required: false },
      ],
    },
    {
      id: 'property-details',
      ...
      required: false,
      fields: [
        { key: 'area', type: 'string', label: 'Diện tích', required: false },
        { key: 'bedrooms', type: 'string', label: 'Phòng ngủ', required: false },
        { key: 'legalStatus', type: 'string', label: 'Pháp lý', required: false },
      ],
    },
  ],
};
