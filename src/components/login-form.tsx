...
function getErrorMessage(err: unknown): string {
  ...
  if (err && typeof err === "object" && "code" in err && typeof (err as { code?: unknown }).code === "string") {
    ...
    // Có thể bổ sung các case khác nếu muốn
...
export function LoginForm({
  ...
  const [password, setPassword] = useState(
    typeof process.env.NEXT_PUBLIC_FIREBASE_TEST_PASSWORD === "string"
      ? process.env.NEXT_PUBLIC_FIREBASE_TEST_PASSWORD
      : ""
  )
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Lấy ID token và gửi lên API để set cookie đăng nhập
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-muted-foreground text-balance">
                  Đăng nhập vào tài khoản PropMate của bạn
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                <Button variant="outline" type="button" className="w-full">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-labelledby="appleLoginTitle">
                    <title id="appleLoginTitle">Đăng nhập với Apple</title>
                    <path
                ...
                <Button variant="outline" type="button" className="w-full">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-labelledby="googleLoginTitle">
                    <title id="googleLoginTitle">Đăng nhập với Google</title>
                    <path
                ...
                <Button variant="outline" type="button" className="w-full">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-labelledby="metaLoginTitle">
                    <title id="metaLoginTitle">Đăng nhập với Meta</title>
                    <path
